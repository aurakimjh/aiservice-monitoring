...
> **최종 업데이트**: 2026-03-27 (Session 53 — Phase 41~47 전체 완료: v1.1 실연동 로드맵 완성)
...
Phase 47:    APM 서비스 대시보드 위젯 (8종)                           ████████████ 100% ✅
...
── Phase 47: APM 서비스 대시보드 가젯 ✅ (2026-03-27) ─────────────────────
[79] Phase 47-1: TPS 가젯                                         [██████████] 100%  ✅
     · 실시간 TPS area 차트 + 현재 값 큰 숫자, 5초 간격 120포인트
[80] Phase 47-2: 금일 TPS 가젯 (일간 비교)                        [██████████] 100%  ✅
     · 오늘 파란 실선 vs 어제 회색 배경 영역, 변화율(%) 자동 표시
[81] Phase 47-3: 금일 사용자 수 가젯 (일간 비교)                  [██████████] 100%  ✅
     · 오늘 녹색 실선 vs 어제 회색, 동시접속 사용자 카운팅
[82] Phase 47-4: 평균 응답시간 가젯                                [██████████] 100%  ✅
     · Warning 500ms / Critical 1s 임계치 점선, 값 기반 자동 색상 전환
[83] Phase 47-5: 액티브 트랜잭션 가젯                              [██████████] 100%  ✅
     · area 차트 + 큰 숫자, 파랑→노랑→빨강 색상 에스컬레이션
[84] Phase 47-6: 액티브 스테이터스 가젯                            [██████████] 100%  ✅
     · METHOD/SQL/HTTPC/DBC/SOCKET 5단 바, Connection Pool Warning 깜빡임
[85] Phase 47-7: 액티브 트랜잭션 스피드 차트                       [██████████] 100%  ✅
     · 3단 플로우: RPS→Processing→TPS, Backlog 감지 빨강 전환
[86] Phase 47-8: 동시접속 사용자 가젯                              [██████████] 100%  ✅
     · 30분 area 차트 + 현재 값 큰 숫자, 대시보드 APM 그룹 등록
