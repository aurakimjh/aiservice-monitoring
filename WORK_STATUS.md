...
── Phase 44: Frontend 실데이터 전환 (Tier 3 — AI/고급, 마지막) ✅ (2026-03-27)
[65] Phase 44-1: AI 서비스 뷰 (/ai)                              [██████████] 100%  ✅
     · useDataSource('/ai/services') → AI 서비스 목록 실데이터
     · DataSourceBadge 페이지 헤더에 표시, 30초 자동 갱신
[66] Phase 44-2: SLO 뷰 (/slo)                                   [██████████] 100%  ✅
     · useDataSource('/slo/definitions') → SLO 정의 + ('/slo/probes') → 합성 프로브
     · DataSourceBadge 표시, 30초 자동 갱신
[67] Phase 44-3: 프로파일링 (/profiling)                          [██████████] 100%  ✅
     · useDataSource('/profiling/profiles') → 프로필 목록 실데이터
[68] Phase 44-4: 진단 (/diagnostics)                              [██████████] 100%  ✅
     · useDataSource('/diagnostics/runs') → 진단 실행 이력 실데이터
[69] Phase 44-5: 나머지 페이지 (11개)                             [██████████] 100%  ✅
     · useDataSource 전환: /anomalies, /copilot, /batch, /cloud, /pipelines, /business, /marketplace (7개)
     · 정적 DataSourceBadge: /golden-signals, /rum, /runtime, /database (4개 — 인라인 데이터)
     · 전 페이지 DataSourceBadge(LIVE/DEMO) 표시 완료
```
